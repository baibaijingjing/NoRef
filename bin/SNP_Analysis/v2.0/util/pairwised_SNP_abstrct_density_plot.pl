...
my $cmd =  "$Rscript $Bin/plot_SNP_stat.R --infile $odir/AllSample.SNP_density.stat --outfile $odir/AllSample.SNP_density.png --x.col 2 --group.col 1 --y.col 3 --x.lab \"SNP Number per Kb\" --group.lab \"Sample\" --y.lab \"Number of Gene\" --title.lab \"SNP Density\" --legend.col 1  ";
print $cmd."\n";
