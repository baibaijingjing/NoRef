...
##modify by xugl  2015-11-14 
system"mv $dOut/work_sh/STAR2.sh $dOut/work_sh/STAR2.sh.bak" if (-e "$dOut/work_sh/STAR2.sh");
...
sub alignToGenome{
	...
	$starcmd2.=" --outSAMtype BAM SortedByCoordinate --limitBAMsortRAM  60000000000 --twopassMode Basic";
	$starcmd2.="\n";
