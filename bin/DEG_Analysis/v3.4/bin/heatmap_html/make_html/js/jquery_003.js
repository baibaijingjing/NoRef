...
!function (a, b) {
        ...
        if (d.stepCount > 0) {
            ...
            if (!c.enableContentCache || !e.contentLoaded)switch (r($, e.contentMode)) {
                case $.iframe:
                    ...
                    break;
                case $.async:
                    var f = k(b, d.currentIndex)._aria("busy", "true").empty().append(M(c.loadingTemplate, {text: c.labels.loading}));
                    a.ajax({url: e.contentUrl, cache: !1}).done(function (a) {
    ...
    function P(b, c, d, e, f) {
        var g = b.find(".content > .body"), h = r(ab, c.transitionEffect), i = c.transitionEffectSpeed, j = g.eq(e), k = g.eq(f);
        switch (h) {
            case ab.fade:
            case ab.slide:
                var l = h === ab.fade ? "fadeOut" : "slideUp", m = h === ab.fade ? "fadeIn" : "slideDown";
                ...
                break;
            case ab.slideLeft:
                var o = k.outerWidth(!0), p = e > f ? -o : o, q = e > f ? o : -o;
                k.animate({left: p}, i, function () {
                    a(this)._showAria(!1)
                }).promise(), j.css("left", q + "px")._showAria().animate({left: 0}, i).promise();
                break;
            default:
    ...
    var $ = a.fn.steps.contentMode = {html: 0, iframe: 1, async: 2}, _ = a.fn.steps.stepsOrientation = {
        ...
        labels: {
            ...
            finish: JS_internationalization.app_analysis.finish,
            next: JS_internationalization.app_analysis.next,
            previous: JS_internationalization.app_analysis.previous,
            loading: "Loading ..."
        }
    }
}(jQuery);