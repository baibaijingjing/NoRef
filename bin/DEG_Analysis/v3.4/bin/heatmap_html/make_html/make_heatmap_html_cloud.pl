...
<head lang="zh-cn">
    ...
    <link href="project_heatmap_Path/css/bootstrap.min.css" rel="stylesheet">
    <link href="project_heatmap_Path/css/font-awesome/css/font-awesome.css" rel="stylesheet">

    <link href="project_heatmap_Path/css/animate.css" rel="stylesheet">
    <link href="project_heatmap_Path/css/style.css" rel="stylesheet">
...
<body class="white-bg" onload="reurl()">

<div class="map-content">
    <div class="row text-center map-head">
        <span>Heatmap数据挖掘</span>
        <img src="project_heatmap_Path/logo_zh.png" alt="">
    </div>
    ...
    <div class="map-content-div">
        ...
        <div class="map-content-left pull-left">
            <div>
                <img src="project_heatmap_Path/$heatmap_file" usemap="#mapMap" id="sourceImg">
            </div>
...
foreach my $num (sort {$a<=>$b} keys %heatmap) {
	$html .= <<"HTML_FILE_AND_TABLE";
        <div class="map-content-right text-center pull-left" id="${num}map-result">
            <div>
                <img src="project_heatmap_Path/$heatmap{$num}{'png'}" alt="" class="img-container">
            </div>
            <div>
                <img src="project_heatmap_Path/$heatmap{$num}{'data_png'}" alt="" class="img-container">
            </div>
            <div class="text-left">
...
<!-- Mainly scripts -->
<script src="project_heatmap_Path/js/jquery-2.1.1.js"></script>
<script src="project_heatmap_Path/js/bootstrap.min.js"></script>

<script>
    \$(document).ready(function(){
        \$("body").width(\$(window).innerWidth()*0.8+'px');
        \$(".map-content").width(\$(window).innerWidth()*0.8+'px');
        ...
        \$(".map-content-div").css("margin-left",(\$(window).innerWidth()*0.8-imgWidth-490)*0.5+'px');
...
open OUT,">$dir/heatmap.html.cloud";
print OUT "$html";
close OUT;
