...
# Modified:       correct some SVG grammar error, and three-set venn layout problem.
# Program Date:   2015-05-14.
# Modifier:       Simon Young <yangxh@biomarker.com.cn>
# Modified:       delete the specious four-set venn.
...
#	$svgout1=&veen4($font1,$font,$sample{"A"},$sample{"B"},$sample{"C"},$sample{"D"},$total_value{"A"},$total_value{"B"},$total_value{"C"},$total_value{"D"},$value{"A"},$value{"B"},$value{"C"},$value{"D"},$value{"AB"},$value{"AC"},$value{"AD"},$value{"BC"},$value{"BD"},$value{"CD"},$value{"ABC"},$value{"ABD"},$value{"ACD"},$value{"BCD"},$value{"ABCD"}); # specious 4-set venn playout
...
system("perl $svg2xxx $outfile -t $type ");
#
# if n = 4; then 
# n^2 - n + 2 < sum(combntns(n,n) + combntns(n,n-1) + ... + combntns(n,2) + combntns(n,1) ).
# so, draw a practical four-set venn with 4 circles in a plane is impossible.
#
#if ($count==4) {
...
<svg xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg" version="1.0" width="600" height="600" id="svg2837">
  ...
  <g
	...
	<text
	   ...
	   id="text4231"
	   xml:space="preserve"
       transform="translate(-30,-20) rotate(-90 -6.714287 885.07648)"
	...
	<text
	   ...
	   id="text4231"
	   xml:space="preserve"
       transform="translate(30,-20) rotate(90 455.714287 885.07648)"
	   style="font-size:$fontpx1;font-style:normal;font-weight:normal;text-align:center;text-anchor:start;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans"><tspan
		 x="455.714287"
		 y="885.07648"
		 id="tspan4233"
		 style="font-size:$fontpx1;text-align:center;text-anchor:start;fill:#000000;fill-opacity:1;font-family:Sans;-inkscape-font-specification:Sans">$TB</tspan></text>
	<text
	   x="223.714287"
	   y="1215.07648"
	   id="text4231"
	...
	<text
	   ...
	   id="text4231"
	   xml:space="preserve"
       transform="rotate(-90 -6.714287 908.07648)"
	   style="font-size:$fontpx;font-style:normal;font-weight:normal;text-align:center;text-anchor:middle;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans"><tspan
		 ...
		 y="908.07648"
		 id="tspan4233"
		 style="font-size:$fontpx;text-align:center;text-anchor:middle;fill:#000000;fill-opacity:1;font-family:Sans;-inkscape-font-specification:Sans">$TAn</tspan></text>
	<text
	   x="455.714287"
	   y="908.07648"
	   id="text4231"
	   xml:space="preserve"
       transform="rotate(90 455.714287 908.07648)"
	   style="font-size:$fontpx;font-style:normal;font-weight:normal;text-align:center;text-anchor:middle;fill:#000000;fill-opacity:1;stroke:none;font-family:Sans"><tspan
		 x="455.714287"
		 y="908.07648"
		 id="tspan4233"
		 style="font-size:$fontpx;text-align:center;text-anchor:middle;fill:#000000;fill-opacity:1;font-family:Sans;-inkscape-font-specification:Sans">$TBn</tspan></text>
	<text
	   x="223.714287"
	   y="1238.07648"
	   id="text4231"
