...
my  $in1=$opts{i1};
my $in2=$opts{i2} ;#"/share/nas5/RNA_seq/Project/RNA_seq/Cabbage/Analysis/Map_evaluate_20110715/Cabbage_A-WT/Cabbage_A-WT.geneExpression.xls";##这是FPKM值会发生变化
...
`perl $distributing_svg $out.gene_tag.list  $out.gene_tag.svg` ;
#`cd result`;##
`$svg2xxx $out.gene_tag.svg -m 10233`;
