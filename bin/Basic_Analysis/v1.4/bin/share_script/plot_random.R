...
plot_random=function(infile,width=120,height=60,col="red",bg=F,od=NULL){
  library(ggplot2)
  library(grid)
  ...
  p=ggplot(data, aes(x=x, y=y, colour=Sample))+
    ...
    ylim(ylim)+guides(col = guide_legend(nrow=12))
