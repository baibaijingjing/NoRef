...
#print OUT "FORWARD PRIMER1 (5'-3')\tTm(¡æ)\tsize\tREVERSE PRIMER1 (5'-3')\tTm(¡æ)\tsize\tPRODUCT1 size (bp)\tstart (bp)\tend (bp)\t";
#print OUT "FORWARD PRIMER2 (5'-3')\tTm(¡æ)\tsize\tREVERSE PRIMER2 (5'-3')\tTm(¡æ)\tsize\tPRODUCT2 size (bp)\tstart (bp)\tend (bp)\t";
#print OUT "FORWARD PRIMER3 (5'-3')\tTm(¡æ)\tsize\tREVERSE PRIMER3 (5'-3')\tTm(¡æ)\tsize\tPRODUCT3 size (bp)\tstart (bp)\tend (bp)\n";
undef $/;
my $in = <IN>;
study $in;
