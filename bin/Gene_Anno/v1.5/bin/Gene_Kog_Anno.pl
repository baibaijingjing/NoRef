...
foreach my $subfile (@subfiles) {
	...
	#print OUT "$blastall -b 100 -v 100 -p blastx -e $Blast_e -F F -d $Database -i $subfile -a 2 -o $odir/Kog_Dir/$name.Kog.blast && \n";
...
`perl $Bin/bin/blast_format.pl -id $odir/Kog_Dir -od $Tab_dir -shdir $sh_dir -middir $odir/mid --kog -queue $queue`;
