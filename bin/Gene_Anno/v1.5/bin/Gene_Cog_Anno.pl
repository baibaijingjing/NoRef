...
my $blastx = $sys_cfg{blast}."/blastx";# xugl 2016-3
...
foreach my $subfile (@subfiles) {
	...
	#print OUT "$blastall -b 100 -v 100 -p blastx -e $Blast_e -F F -d $Database -i $subfile -a 2 -o $odir/Cog_Dir/$name.Cog.blast && \n";
...
`perl $Bin/bin/blast_format.pl -id $odir/Cog_Dir -od $Tab_dir -shdir $sh_dir  -middir $odir/mid --cog -queue $queue`;
