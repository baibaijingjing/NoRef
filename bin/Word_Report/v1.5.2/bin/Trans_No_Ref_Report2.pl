...
my ($DEGcondition1,$DEGcondition2,$DEG_vs_name) = ('','','');  ## �������Ŀ¼����
my ($br_replicate1,$br_replicate2);
my $assembly = 'single';    #Ĭ��Ϊ�ϲ�����������װ����ֻ��һ��Transcript��
...
if (-d "$dir_data/DEG_Analysis/") {
    ...
    my (%DEG_br_vs,%DEG_nbr_vs);
    for my $i (0..$#DEGresult) {
        $DEGresult[$i] =~ /\/((\w+)_vs_(\w+))\//;
        my ($vs,$A,$B) = ($1,$2,$3);
        if ($2=~/_/ or $3=~/_/) {
            $DEG_br_vs{$vs}{'A'} = $A;
            $DEG_br_vs{$vs}{'B'} = $B;
...
system "cd $outdir/ && zip ${fkey}_Report.rtf.zip ${fkey}_Report.rtf";
#######################################################################################
...
sub get_picture {#
	...
	my $data_stat=(glob "$dir_data/cleandata/PNG/*.rawDataStat.png")[0];
...
#       "����Ƭ�γ���ģ��ֲ�ͼ"=>["$dir_data/geneExpression/$br_replicate1.insertSize.r.png",[ 60, 60]],
        "ת¼��������ݱ��Ͷ�ģ��ͼ"=>["$dir_data/geneExpression/Total.gene_tag.png",[ 60, 60]],
		"CDS��������ļ�ʾ��ͼ"=>["$dir_template/P10_CDS_example.png",[ 90, 90]],
...
#		"����Ʒ�Ļ�������ɢ��ͼ"=>["$dir_data/DEG_Analysis/$DEG_vs_name/$DEG_vs_name.cor.png",[ 70, 70]],
		"����������ɽͼ"=>["$dir_data/DEG_Analysis/$DEG_vs_name/$DEG_vs_name.FC_FDR.png",[ 70, 70]],
		"���������MAͼ"=>["$dir_data/DEG_Analysis/$DEG_vs_name/$DEG_vs_name.FC_count.png",[ 70, 70]],

		"���������topGO���������޻�ͼ�����ӹ��ܣ�"=>["$dir_data/DEG_Analysis/$DEG_vs_name/Graph/$DEG_vs_name.topGO_MF.png", [100,100]],
		"���������COGע�ͷ���ͳ��ͼ"=>["$dir_data/DEG_Analysis/$DEG_vs_name/Cog_Anno/$DEG_vs_name.Cog.classfy.png",[60,60]],

       "����������KEGGͨ·ע��ͼʾ��ͼ"=>["$dir_template/P20_pathway_example.png",[ 60, 60]],
#       "���������KEGG����ͼ"=>["$dir_template/DEG_vs_name.KEGG.Phase.png",[ 100, 100]], #tmp
#		"��Ʒ�������ͼ"=>["$dir_data/geneExpression/sample_cluster.png",[ 70, 70]],
	);

    ## ����Ƭ�γ���ģ��ֲ�ͼ
    if (-e "$dir_data/geneExpression/$br_replicate1.insertSize.r.png") {
        $pic_info{"����Ƭ�γ���ģ��ֲ�ͼ"} = ["$dir_data/geneExpression/$br_replicate1.insertSize.r.png",[60,60]];
    } else {
        $pic_info{"����Ƭ�γ���ģ��ֲ�ͼ"} = ["$dir_data/geneExpression/$br_replicate1.insertSize.png",[50,50]];
    }

    ## 
    if ($br_replicate2) {
        if (-e "$dir_data/geneExpression/cor_plot/${br_replicate1}_vs_${br_replicate2}.cor.png") {
            $pic_info{"����Ʒ�Ļ�������ɢ��ͼ"} = ["$dir_data/geneExpression/cor_plot/${br_replicate1}_vs_${br_replicate2}.cor.png",[ 70, 70]];
        } elsif (-e "$dir_data/geneExpression/cor_plot/${br_replicate2}_vs_${br_replicate1}.cor.png") {
            $pic_info{"����Ʒ�Ļ�������ɢ��ͼ"} = ["$dir_data/geneExpression/cor_plot/${br_replicate2}_vs_${br_replicate1}.cor.png",[ 70, 70]];
        } else {
            $pic_info{"����Ʒ�Ļ�������ɢ��ͼ"} = ["$dir_template/none.jpg",[100,100]];
        }
    }

    # SNP�ܶȷֲ�ͼ
    if (-e "$dir_data/SNP_Analysis/AllSample.SNP_density.png") {
        $pic_info{"SNP�ܶȷֲ�ͼ"} = ["$dir_data/SNP_Analysis/AllSample.SNP_density.png",[80,80]];
    } else {
        $pic_info{"SNP�ܶȷֲ�ͼ"} = ["$dir_template/none.jpg",[100,100]];
    }

	## �����������ģʽ����ͼ
#	if (-d "$dir_data/DEG_Analysis/All_DEG/") {
#		if (-e "$dir_data/DEG_Analysis/All_DEG/DEG_Cluster/hierarchical/All_DEG.DEG.cluster.png") {
#			$pic_info{"�����������ģʽ����ͼ"} = ["$dir_data/DEG_Analysis/All_DEG/DEG_Cluster/hierarchical/All_DEG.DEG.cluster.png",[95,95]];
#		}
#		else{
#			$pic_info{"�����������ģʽ����ͼ"} = ["$dir_template/none.jpg",[80,80]];
#		}
#	}
#    else{
		if (-e "$dir_data/DEG_Analysis/$DEG_vs_name/$DEG_vs_name.DEG.heatmap.png") {
			$pic_info{"�����������ģʽ����ͼ"} = ["$dir_data/DEG_Analysis/$DEG_vs_name//$DEG_vs_name.DEG.heatmap.png",[95,95]];
		}
		else{
			$pic_info{"�����������ģʽ����ͼ"} = ["$dir_template/none.jpg",[80,80]];
		}
#	}
    ...
    ## ���������GO�����ڵ�ע��ͳ��ͼ
	if (-e "$dir_data/DEG_Analysis/$DEG_vs_name/go_enrichment/$DEG_vs_name.GO.png") {
		$pic_info{"���������GO�����ڵ�ע��ͳ��ͼ"}=["$dir_data/DEG_Analysis/$DEG_vs_name/go_enrichment/$DEG_vs_name.GO.png", [45,45]];
	}
	else {
		$pic_info{"���������GO�����ڵ�ע��ͳ��ͼ"}=["$dir_template/none.jpg", [40,40]];
	}

    ## ���������KEGGͨ·����ɢ��ͼ
	if (-e "$dir_data/DEG_Analysis/$DEG_vs_name/Graph/$DEG_vs_name.KEGG.Phase.png") {
		$pic_info{"���������KEGGͨ·����ɢ��ͼ"}=["$dir_data/DEG_Analysis/$DEG_vs_name/Graph/$DEG_vs_name.KEGG.Phase.png", [60,60]];
	}
	else {
		$pic_info{"���������KEGGͨ·����ɢ��ͼ"}=["$dir_template/none.jpg", [40,40]];
	}

	## �������ά��ͼ
	if (-f "$dir_data/DEG_Analysis/All_DEG_veen.png") {
		$pic_info{"�������ά��ͼ"}=["$dir_data/DEG_Analysis/All_DEG_veen.png",[ 80, 80]];
	}else{
		$pic_info{"�������ά��ͼ"}=["$dir_template/All_sample_veen.jpg",[ 80, 80]];
	}

    ## ���������KEGG����ͼ
	if (-e "$dir_data/DEG_Analysis/$DEG_vs_name/pathway/kegg_enrichment/$DEG_vs_name.KEGG.png") {
		$pic_info{"���������KEGG����ͼ"}=["$dir_data/DEG_Analysis/$DEG_vs_name/pathway/kegg_enrichment/$DEG_vs_name.KEGG.png", [60,60]];
	}
	else {
		$pic_info{"���������KEGG����ͼ"}=["$dir_template/none.jpg", [40,40]];
	}

	## �������KEGGͨ·ʾ��ͼ
#	my @kegg_map = glob("$dir_data/DEG_Analysis/$DEG_vs_name/pathway/kegg_map/*png");
#	if (@kegg_map == 0) {
#		$pic_info{"�������KEGGͨ·ʾ��ͼ"} = ["$dir_template/none.jpg",[60,60]];
#	}
#	else{
#		$pic_info{"�������KEGGͨ·ʾ��ͼ"} = [$kegg_map[0],[60,60]];
#	}
...
sub get_table {#
    ...
    #---------------------------------------------------------------
	@ftable = glob "$dir_data/geneExpression/*.statMapped.xls";

    for $ftable (@ftable) {
        my ($sample_id) = $ftable =~/\/([^\/]+).statMapped.xls$/;
        my ($clean_num, $mapped_num, $mapped_ratio) = (0,0,'');
        open (TAB,$ftable) or die $!;
        $/="\n";
        while (<TAB>) {
...
#		close (TAB) ;
	...
	## ��7 SSR��������ļ�ʾ���
    # width
    @{$table_info{"SSR��������ļ�ʾ���"}{"width"}}= (2308,1000,1208,1422,954,954,954);
    ...
    ## ��9 SNP��������ļ�ʾ���
    # width
    @{$table_info{"SNP��������ļ�ʾ���"}{"width"}}= (1868,934,1108,1108,1134,1208,1448);
    @{$table_info{"SNP��������ļ�ʾ���"}{"align"}}= ('c','c','c','c','c','c','c');
    #info
    $ftable = "$dir_data/SNP_Analysis/$br_replicate1.snp.list";
    open (TAB,$ftable) or die $!;
	$/="\n";
	while (<TAB>) {
		chomp;
		...
		my @table9 = split /\s+/,$_;
        $table9[0]=~s/^#//;
		push @{$table_info{"SNP��������ļ�ʾ���"}{"table"}},[@table9];
        last if ($.>8);
	}
	close (TAB);
	...
	## ��10 SNP����ͳ�Ʊ�
	# width
	@{$table_info{"SNP����ͳ�Ʊ�"}{"width"}}= (2200,2200,2200,2200);
	@{$table_info{"SNP����ͳ�Ʊ�"}{"align"}}= ('c','c','c','c');
    push @{$table_info{"SNP����ͳ�Ʊ�"}{"table"}},['Samples','HomoSNP','HeteSNP','AllSNP'];
	# info
	$ftable = "$dir_data/SNP_Analysis/AllSample.snp.stat";
	open (TAB,$ftable) or die $!;
	$/="\n";
	while (<TAB>) {
		chomp;
        ...
        $table8[0]=~s/^#//;
		if ($.>1) {
			for (my $t_v=1;$t_v<@table8 ;$t_v++) {
				$table8[$t_v]=format_figure($table8[$t_v]);
			}
            push @{$table_info{"SNP����ͳ�Ʊ�"}{"table"}},[@table8];
		}
	}
	close (TAB) ;
    ...
    ## ��11 ������������ļ�ʾ���
    #info
    $ftable = "$dir_data/geneExpression/$br_replicate1.geneExpression.xls";
    open (TAB,$ftable) or die $!;
    $/="\n";
    ...
    if ($assembly eq 'single') {
        ...
        while (<TAB>) {
            chomp;
            next if(/^$/);
            my @table10 = split /\s+/,$_;
            $table10[0]=~s/^#//;
            push @{$table_info{"������������ļ�ʾ���"}{"table"}},[@table10];
            last if ($.>8);
        }
    } else {
        # width
        @{$table_info{"������������ļ�ʾ���"}{"width"}}= (1680,900,850,990,880,1180,1140,1180);
        @{$table_info{"������������ļ�ʾ���"}{"align"}}= ('c','c','c','c','c','c','c','c');

        while (<TAB>) {
            chomp;
            next if(/^$/);
            my ($gene,$length,$depth,$coverage,$FPKM,$totalReads,$uniqPosiReads,$mulitPosiReads) = split /\s+/,$_;

            if ($.==1) {
                $gene =~ s/^#//;
            } else {
                $depth = sprintf("%.4f",$depth);
                $coverage = sprintf("%.4f",$coverage);
                $FPKM = sprintf("%.4f",$FPKM);
            }

            push @{$table_info{"������������ļ�ʾ���"}{"table"}},[$gene,$length,$depth,$coverage,$FPKM,$totalReads,$uniqPosiReads,$mulitPosiReads];
            last if ($.>8);
        }
    }
    close (TAB);
	...
	## ��12 ����ѧ�ظ������ͳ�Ʊ�
	@{$table_info{"����ѧ�ظ������ͳ�Ʊ�"}{"width"}}=(2500,2500,3808);
	@{$table_info{"����ѧ�ظ������ͳ�Ʊ�"}{"align"}}=('c','c','c');
	push @{$table_info{"����ѧ�ظ������ͳ�Ʊ�"}{"table"}},["Sample 1","Sample 2",'r^2'];
	$ftable = "$dir_data/geneExpression/free_com.cor";
	open (TAB,$ftable) or die $!;
	$/="\n";
	my @Sam;
	my %COR;
	foreach my $key7 (split/\s+/,(scalar <TAB>)) {
		if ($key7=~/decor\./) {
			my $name7=$key7;
			$name7=~s/decor\.//;
			push @Sam,$name7;
	...
	while (<TAB>) {
		...
		next if(/^$/);
		my @A = split /\s+/,$_;
		for (my $i7=1;$i7<=$limit ;$i7++) {
			next if $A[0] eq $Sam[$i7-1];
			next if exists $COR{$Sam[$i7-1]}{$A[0]};
			$COR{$A[0]}{$Sam[$i7-1]}=$A[$i7];
		}
	}
	foreach my $key1 (keys %COR) {
		foreach my $key2 (keys %{$COR{$key1}}) {
            my $r_sq = sprintf("%.4f", $COR{$key1}{$key2});
			push @{$table_info{"����ѧ�ظ������ͳ�Ʊ�"}{"table"}},[$key1,$key2,$r_sq];
		}
	}
	close (TAB) ;
    ...
    ## ��13 ������������ʾ���
    #info
    $ftable = "$dir_data/DEG_Analysis/$DEG_vs_name/$DEG_vs_name.DEG_final.xls";
    open (TAB,$ftable) or die $!;
	$/="\n";
	while (<TAB>) {
		chomp;
		next if(/^$/);
		my @table12 = (split /\s+/,$_);

        if (@table12==6) {
            my ($deg_id,$fpkm1,$fpkm2,$fdr,$fc,$reg) = @table12[0,1,2,-3,-2,-1];

            if ($.==1) {
                # width
                @{$table_info{"������������ʾ���"}{"width"}}= (2258,1250,1250,1600,1250,1200);
                @{$table_info{"������������ʾ���"}{"align"}}= ('c','c','c','c','c','c');
                $deg_id =~s/^#/Gene/;
            } else {
                $fpkm1 = sprintf("%.4f",$fpkm1);
                $fpkm2 = sprintf("%.4f",$fpkm2);
                $fdr = sprintf("%.4e",$fdr);
                $fc = sprintf("%.4f",$fc);
            }

            push @{$table_info{"������������ʾ���"}{"table"}},[$deg_id,$fpkm1,$fpkm2,$fdr,$fc,$reg];
        } elsif (@table12>6) {
            my ($deg_id,$fpkm1,$fpkm2,$fdr,$fc,$reg) = @table12[0,1,2,-3,-2,-1];

            if ($.==1) {
                # width
                @{$table_info{"������������ʾ���"}{"width"}}= (2258,1200,1200,550,1600,1000,1000);
                @{$table_info{"������������ʾ���"}{"align"}}= ('c','c','c','c','c','c','c');
                $deg_id =~s/^#/Gene/;
            } else {
                $fpkm1 = sprintf("%.4f",$fpkm1);
                $fpkm2 = sprintf("%.4f",$fpkm2);
	...
	## ��14 �����������Ŀͳ�Ʊ�
    if ($DEGcondition1 =~ /_/) {
        @{$table_info{"�����������Ŀͳ�Ʊ�"}{"width"}}=(3408,1800,1800,1800);
    } else {
        @{$table_info{"�����������Ŀͳ�Ʊ�"}{"width"}}=(2408,2000,2200,2200);
    }
    @{$table_info{"�����������Ŀͳ�Ʊ�"}{"align"}}=('c','c','c','c');
	$ftable = "$dir_data/DEG_Analysis/DEG.stat";
	open (TAB,$ftable) or die $!;
	$/="\n";
	while (<TAB>) {
		chomp;
		next if(/^$/);
		my ($set,@info13) = split /\t/,$_;
        $set =~ s/^#//;
		@info13 = (format_figure($info13[0]), format_figure($info13[1]), format_figure($info13[2]));
		push @{$table_info{"�����������Ŀͳ�Ʊ�"}{"table"}},[$set,@info13];
	}
	close (TAB) ;


	## ��15 ע�͵Ĳ������������ͳ�Ʊ�
	$ftable = "$dir_data/DEG_Analysis/DEG.anno.stat";
	my $DE_Anno_limit=0;
	open (TAB,$ftable) or die $!;
	$/="\n";
	while (<TAB>) {
		chomp;
		next if /^$/;
		my @DE_Anno_limit=split /\t/,$_;
		$DE_Anno_limit=@DE_Anno_limit;
		last;
	}
	close (TAB) ;

	if ($DE_Anno_limit==9) {
		@{$table_info{"ע�͵Ĳ������������ͳ�Ʊ�"}{"width"}}=(1808,1080,750,800,850,750,850,1080,840);
		@{$table_info{"ע�͵Ĳ������������ͳ�Ʊ�"}{"align"}}=('c','c','c','c','c','c','c','c','c');
		open (TAB,$ftable) or die $!;
		$/="\n";
		while (<TAB>) {
			chomp;
			...
			my @info14 = split /\t/,$_;
            $info14[0] =~ s/^#//;
			@info14 = ($info14[0],format_figure($info14[1]), format_figure($info14[2]), format_figure($info14[3]),
				format_figure($info14[4]), format_figure($info14[5]), format_figure($info14[6]), format_figure($info14[7]), format_figure($info14[8]));
			push @{$table_info{"ע�͵Ĳ������������ͳ�Ʊ�"}{"table"}},[@info14];
		}
		close (TAB) ;
	}
	elsif ($DE_Anno_limit==10){
		@{$table_info{"ע�͵Ĳ������������ͳ�Ʊ�"}{"width"}}=(1008,1080,750,800,850,750,850,1000,950,840);
		@{$table_info{"ע�͵Ĳ������������ͳ�Ʊ�"}{"align"}}=('c','c','c','c','c','c','c','c','c','c',);
		open (TAB,$ftable) or die $!;
		$/="\n";
		while (<TAB>) {
			chomp;
            ...
            $info14[0] =~ s/^#//;
			@info14 = ($info14[0],format_figure($info14[1]), format_figure($info14[2]), format_figure($info14[3]),
				format_figure($info14[4]), format_figure($info14[5]), format_figure($info14[6]), format_figure($info14[7]), format_figure($info14[8]), format_figure($info14[9]));
			push @{$table_info{"ע�͵Ĳ������������ͳ�Ʊ�"}{"table"}},[@info14];
		}
		close (TAB) ;
	}
	elsif ($DE_Anno_limit==11) {
		@{$table_info{"ע�͵Ĳ������������ͳ�Ʊ�"}{"width"}}=(1008,1080,750,800,850,750,850,1000,840,840,840);
		@{$table_info{"ע�͵Ĳ������������ͳ�Ʊ�"}{"align"}}=('c','c','c','c','c','c','c','c','c','c','c');
		open (TAB,$ftable) or die $!;
		$/="\n";
		while (<TAB>) {
			chomp;
            ...
            $info14[0] =~ s/^#//;
			@info14 = ($info14[0],format_figure($info14[1]), format_figure($info14[2]), format_figure($info14[3]),
				format_figure($info14[4]), format_figure($info14[5]), format_figure($info14[6]), format_figure($info14[7]), format_figure($info14[8]), format_figure($info14[9]), format_figure($info14[10]));
			push @{$table_info{"ע�͵Ĳ������������ͳ�Ʊ�"}{"table"}},[@info14];
		}
		close (TAB) ;
	}
	else{
		print "Check Your $dir_data/DEG_Analysis/DEG.anno.stat\n";
		@{$table_info{"ע�͵Ĳ������������ͳ�Ʊ�"}{"width"}}=(2808,1200,1200,1200,1200,1200);
		@{$table_info{"ע�͵Ĳ������������ͳ�Ʊ�"}{"align"}}=('c','c','c','c','c','c');
		push @{$table_info{"ע�͵Ĳ������������ͳ�Ʊ�"}{"table"}},["XXX","XXX","XXX","XXX","XXX","XXX"];
    }

    ## ��16 ���������topGO�������ʾ�������ӹ��ܣ�
    # width
    @{$table_info{"���������topGO�������ʾ�������ӹ��ܣ�"}{"width"}}= (1401,3003,1201,1201,1001,1001);
    @{$table_info{"���������topGO�������ʾ�������ӹ��ܣ�"}{"align"}}= ('c','c','c','c','c','c');
    #info
    $ftable = "$dir_data/DEG_Analysis/$DEG_vs_name/Graph/$DEG_vs_name.topGO_MF.xls";
    open (TAB,$ftable) or die $!;
	$/="\n";
	while (<TAB>) {
		chomp;
		next if(/^$/);
		my @table15 = split /\t/,$_;
		push @{$table_info{"���������topGO�������ʾ�������ӹ��ܣ�"}{"table"}},[@table15];
        last if ($.>8);
	}
	close (TAB);
    ...
    ## ��17 ����������KEGG�������ֽ��
    # width
    @{$table_info{"����������KEGG�������ֽ��"}{"width"}}= (4504,1001,2002,1301);
    @{$table_info{"����������KEGG�������ֽ��"}{"align"}}= ('c','c','c','c');
    #info
    $ftable = "$dir_data/DEG_Analysis/$DEG_vs_name/Graph/$DEG_vs_name.KEGG.list";
    open (TAB,$ftable) or die $!;
	$/="\n";
	while (<TAB>) {
		chomp;
		next if(/^$/);
		my ($pathway,$ko,$ef,$cor_p) = (split /\t/,$_);

        if ($. == 1) {
            push @{$table_info{"����������KEGG�������ֽ��"}{"table"}},['Pathway','KO','Enrichment_Factor','Q_value'];
        } elsif ($.<10 and $.>1) {
            $cor_p = sprintf("%.4e",$cor_p);
            push @{$table_info{"����������KEGG�������ֽ��"}{"table"}},[$pathway,$ko,$ef,$cor_p];
        } else {
            last;
        }
	}
    ...
    push @{$table_info{"����б�"}{"table"}},['STAR',T('RNA-Seq�ȶ����'),'http://code.google.com/p/rna-star/'];
    push @{$table_info{"����б�"}{"table"}},['GATK',T('���巢�ֺͷ������'),'https://www.broadinstitute.org/gatk/'];
    if ($assembly eq 'single') {
        push @{$table_info{"����б�"}{"table"}},['Bowtie',T('�ȶ����'),'http://bowtie-bio.sourceforge.net/index.shtml'];
    } else {
        push @{$table_info{"����б�"}{"table"}},['BLAT',T('�ȶ����'),'http://genome.ucsc.edu/cgi-bin/hgBlat'];
    }
    ...
    push @{$table_info{"����б�"}{"table"}},['DESeq',T('��������������������������ѧ�ظ������'),'http://www.bioconductor.org/packages/release/bioc/html/DESeq.html'];
    push @{$table_info{"����б�"}{"table"}},['EBSeq',T('��������������������������ѧ�ظ������'),'https://www.biostat.wisc.edu/~kendzior/EBSEQ/'];
...
#	print $context,"\n";
	...
	## exchange
	for (my $i=0; $i<$line;$i++) {
		## DEG condtions to demonstrate
		$context->[$i] =~s/\$DEGcondition1/$DEGcondition1/;
		$context->[$i] =~s/\$DEGcondition2/$DEGcondition2/;
		## br replicate to demonstrate
		$context->[$i] =~s/\$br_replicate1/$br_replicate1/g;
		$context->[$i] =~s/\$br_replicate2/$br_replicate2/g;
